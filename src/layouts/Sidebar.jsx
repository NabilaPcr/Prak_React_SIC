...
export default function Sidebar() {
  ...
  `flex items-center space-x-3 cursor-pointer rounded-xl p-4 font-medium transition ${
    isActive 
      ? 'bg-green-100 text-hijau' 
    ...
    >
      ...
      <div id="sidebar-footer" className="mt-auto">
        <div className="bg-hijau p-5 rounded-2xl shadow-lg mb-6 relative overflow-hidden">
          <p className="text-white text-xs relative z-10 mb-4">
            Please organize your menus through button below!
          </p>
          <button className="flex justify-center items-center w-full p-2 bg-white rounded-xl space-x-2 hover:bg-gray-100 transition relative z-10">
